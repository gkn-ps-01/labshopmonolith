<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-actions>
            ...
            <v-dialog v-model="testDiagram" width="500">
                <TestCommand
                    @closeDialog="closeTest"
                    @test="test"
                ></TestCommand>
            </v-dialog>
        </v-card-actions>
	...
	async created() {
        ...
        methods: {
            ...
            async test(params) {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['test'].href), params)
            ...
            openTest() {
                this.testDiagram = true;
            },
            closeTest() {
                this.testDiagram = false;
            },
        },
    }
</script>
